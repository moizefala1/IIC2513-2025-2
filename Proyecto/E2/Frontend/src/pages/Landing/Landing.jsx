            ...
            <div className="features">
              ...
              <article className="feature">
                ...
                <div className="feature_content">
                  <h3>¿Porque Dawdle?</h3>
                  <p>
                    En inglés, dawdle es sinónimo de procrastinar, dar vueltas o postergar. 404 es el famoso código de internet que significa “not found”. 
                    Juntos, Dawdle 404 expresa nuestra promesa: "procrastinación not found”. Queremos que lo que hoy se pierde
                    entre pendientes y plazos, mañana esté claro, ordenado y bajo control.
                  </p>
                </div>
              </article>
              ...
              <article className="feature">
                ...
                <div className="feature_content">
                  ...
                  <p>
                    Ayudamos a estudiantes universitarios a trabajar de manera óptima, reducir su carga académica y mental, y recuperar tiempo de calidad.
                    Convertimos la ansiedad por lo que “falta” en un plan simple y accionable.
                  </p>
                </div>
              </article>
            </div>
